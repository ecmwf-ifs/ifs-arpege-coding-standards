...
project = 'ECMWF suite design standards'
...
extlinks = {
    ...
    'ecmwf-confluence': ('https://confluence.ecmwf.int/%s', '%s'),
}
...
htmlhelp_basename = 'ECMWF_suites_standarddoc'
...
latex_documents = [
    (master_doc, 'ECMWF_suites_standarddoc.tex', 'ECMWF\\_suite\_design\_standard Documentation',
     'ECMWF', 'manual'),
]
...
man_pages = [
    (master_doc, 'ecmwf_suite_design_standards', 'ECMWF_suite_design_standards Documentation',
     [author], 1)
]
